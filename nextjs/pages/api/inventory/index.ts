...
import { getInventory, getInventoryWithDeals } from '@/utils/prisma/inventory';
...
*/
  ...
  return res.send(await getInventory({ 
    make, model, year, vin, state: state ? +state : undefined, deal
   }));
};
